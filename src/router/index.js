    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: '當前派單',
          component: (resolve) =>
            require(['@/views/staff/CurrentlyTask'], resolve),
        },
        {
          path: 'currentlytask',
          name: '當前派單',
        ...
        },
        {
          ...
          name: '歷史接單',
          component: (resolve) =>
            require(['@/views/staff/HistoryTask'], resolve),
        },
        {
          path: 'attendance',
          name: '出勤紀錄',
          component: (resolve) =>
            require(['@/views/staff/Attendance'], resolve),
        },
        {
          path: 'signature',
          name: 'Signature',
          component: (resolve) => require(['@/views/staff/Signature'], resolve),
        },
      ],
    },
    {
